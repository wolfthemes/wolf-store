        ...
        <div className='wolf-theme-comparison-table wolf-theme-single__section'>
			<div className='wolf-theme-single__wrapper wolf-theme-single__wrapper--small'>
				...
				<p className='wolf-theme-comparison-table__intro'>
					Get continuous updates, direct support, and multi-site licensing.				</p>
				...
				<div className='wolf-theme-comparison-table__cards'>
					...
					<div className='wolf-theme-comparison-table__card wolf-theme-comparison-table__card--wolf'>
						<div className='wolf-theme-comparison-table__card-header'>
							<span className='wolf-theme-comparison-table__card-badge'>Best value</span>
							<h3 className='wolf-theme-comparison-table__card-title'>WolfThemes.com</h3>
							<p className='wolf-theme-comparison-table__card-sub'>Direct from the author</p>
						</div>
						...
						<div className='wolf-theme-comparison-table__card-prices'>
							...
							<div className='wolf-theme-comparison-table__plan wolf-theme-comparison-table__plan--hero'>
								<div className='wolf-theme-comparison-table__plan-meta'>
									<span className='wolf-theme-comparison-table__plan-label'>1 site</span>&nbsp;
									{/* { tfSaving > 0 && ( */}
							...
							{ price_annual_3sites && (
								<div className='wolf-theme-comparison-table__plan'>
									<span className='wolf-theme-comparison-table__plan-label'>3 sites</span>
									<span className='wolf-theme-comparison-table__plan-price'>
					...
					<div className='wolf-theme-comparison-table__card wolf-theme-comparison-table__card--tf'>
						<div className='wolf-theme-comparison-table__card-header'>
							<h3 className='wolf-theme-comparison-table__card-title'>ThemeForest</h3>
							<p className='wolf-theme-comparison-table__card-sub'>Available on the marketplace</p>
						</div>

						<div className='wolf-theme-comparison-table__card-prices'>
							<div className='wolf-theme-comparison-table__plan'>
								<span className='wolf-theme-comparison-table__plan-label'>Regular license</span>
								<span className='wolf-theme-comparison-table__plan-price'>
									{ fmt( tf_price ) }{/*<small> one-time</small>*/}
								</span>
							</div>
							<div className='wolf-theme-comparison-table__plan wolf-theme-comparison-table__plan--muted'>
								<span className='wolf-theme-comparison-table__plan-label'>Support included</span>
								<span className='wolf-theme-comparison-table__plan-price'>Limited time</span>
							</div>
							<div className='wolf-theme-comparison-table__plan wolf-theme-comparison-table__plan--muted'>
								<span className='wolf-theme-comparison-table__plan-label'>Multi-site</span>
								<span className='wolf-theme-comparison-table__plan-price'>Not available</span>
							</div>
						</div>
				...
				<table className='wolf-theme-comparison-table__table'>
					...
					<tbody>
						{ rows.map( ( row, i ) => (
							<tr key={ i } className={ row.wolfWins ? 'wolf-theme-comparison-table__row--win' : '' }>
								<td className='wolf-theme-comparison-table__feature'>{ row.feature }</td>
								<td className='wolf-theme-comparison-table__cell wolf-theme-comparison-table__cell--wolf'>{ row.wolf }</td>
								<td className='wolf-theme-comparison-table__cell wolf-theme-comparison-table__cell--tf'>{ row.tf }</td>
							</tr>
						) ) }
					</tbody>
				</table>
