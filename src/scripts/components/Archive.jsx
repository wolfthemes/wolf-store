            ...
            { showSidebar && (
                <div className='wolf-store-archive__filter-bar'>
                    ...
                    >
                        ...
                        { activeFilterCount > 0 ? <span className='wolf-store-archive__filter-badge'>{ activeFilterCount }</span> : null }
                    </button>
                    { activeFilterCount > 0 && (
                        <button className='wolf-store-archive__filter-clear' onClick={ handleClearFilters }>
                            Clear
                        </button>
                    ) }
                </div>
