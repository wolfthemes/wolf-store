...
class Theme_Index_Params {
    ...
    public static function get_params(): array {
        return array(
            ...
            array(
                ...
                'default'     => 12,
                'admin_label' => true,
                'group'       => esc_html__( 'Query', 'wolf-store' ),
            ),
    ...
    private static function get_category_options(): array {
        ...
        $terms   = get_terms( array( 'taxonomy' => 'theme_cat', 'hide_empty' => false ) );
     ...
     */
    private static function get_tag_options(): array {
        $options = array( '' => esc_html__( 'All', 'wolf-store' ) );
        $terms   = get_terms( array( 'taxonomy' => 'theme_tag', 'hide_empty' => false ) );
